...
async function main() {
  ...
  const structuralCategories = [
    ...
    { id: 4, name: 'Products',       parentId: null, menuId: null,  type: 'product' },
    { id: 5, name: 'Business Types', parentId: null, menuId: null,  type: 'business' },
    { id: 6, name: 'Services',       parentId: null, menuId: null,  type: 'service' },
